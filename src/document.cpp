...
Document Document::FromMarkdown(const std::string& utf8, std::wstring path) {
    Document doc;
    doc.file_path_ = std::move(path);
...
void Document::ReplaceContent(std::vector<Node> new_nodes) {
