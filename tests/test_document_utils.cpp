...
TEST(CalcScrollYForDiff, FallbackWhenNoNodes)
{
    ...
    LayoutCache cache;
    Theme theme{};
    EXPECT_FLOAT_EQ(CalcScrollYForDiff(nodes, cache, theme, "content", 0, 500.0f, 42.0f), 42.0f);
}
...
TEST(CalcScrollYForDiff, FallbackWhenNodeNotFound)
{
    ...
    EXPECT_FLOAT_EQ(CalcScrollYForDiff(nodes, cache, theme, "content", 10, 500.0f, 99.0f), 99.0f);
}
...
TEST(CalcScrollYForDiff, CacheSizeMismatchFallback)
{
    ...
    EXPECT_FLOAT_EQ(CalcScrollYForDiff(nodes, cache, theme, std::string(500, 'x'), 400, 500.0f, 77.0f), 77.0f);
}
